...
use advent_of_code_rust_2024::day10::{part1, part2};
...
fn bench_part1(c: &mut Criterion) {
    ...
    let expected = include_str!("../input/2024/day10.output.1.txt");
...
fn bench_part2(c: &mut Criterion) {
    let input = include_str!("../input/2024/day10.txt");
    let expected = include_str!("../input/2024/day10.output.2.txt");
