...
// use advent_of_code_rust_2024::day20::{part1, part2};
...
//     let expected = include_str!("../input/2024/day20.output.1.txt");
...
//     let input = include_str!("../input/2024/day20.txt");
//     let expected = include_str!("../input/2024/day20.output.2.txt");
